...
public class WaveCompat {
     ...
     */
    public static void startWaveFilter(final Activity activity, WaveDrawable waveDrawable, final Intent intent, int backgroundColor,final View mView) {
        intent.putExtra(IntentKey.BACKGROUND_COLOR, backgroundColor);
        startWaveFilter(activity, waveDrawable, intent,mView);
    }
     ...
     * @param intent
     */
    public static String startWaveFilter(final Activity activity, WaveDrawable waveDrawable, final Intent intent,final View mView) {
...
//                .showAtLocation(contentView, Gravity.NO_GRAVITY, 0, 0);
    ...
    public static void startWaveFilter(final Activity activity, WaveDrawable waveDrawable,final mCallBack mcallBack) {
        //prepareWaveIntent(intent);
...
//                .showAtLocation(contentView, Gravity.NO_GRAVITY, 0, 0);
    ...
    public static void transitionDefaultInitial(Activity activity, int offsetY, int backgroundFromColor, int backgroundToColor) {
        ...
        bgColorAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                //contentView.setBackgroundColor(0xddffffff);//
            }
        });
    ...
    public static void transitionDefaultInitial(final View view) {
        //final View contentView = activity.findViewById(Window.ID_ANDROID_CONTENT);
        ObjectAnimator alphaAnimator = ObjectAnimator.ofFloat(view, "alpha", 0f, 1f);
        alphaAnimator.setDuration(200);
        ValueAnimator marginTopAnimator = ValueAnimator.ofInt(100, 0);
        marginTopAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                int value = (int) animation.getAnimatedValue();
        ...
        ValueAnimator bgColorAnimator = ValueAnimator.ofObject(new ArgbEvaluator(), R.color.abc_background_cache_hint_selector_material_dark, R.color.abc_search_url_text);
        bgColorAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                int value = (int) animation.getAnimatedValue();
        ...
        bgColorAnimator.setDuration(50);
