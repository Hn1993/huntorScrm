...
public class LoginActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        String reLoginPwd = PreferenceUtils.getString(context, Constant.PREFERENCE_PSW_RELOGIN, "");
        ...
        if (intent != null) {
            ...
            if (logout_flag == Constant.LOGOUT_FLAG) {
                MyLogger.i(TAG, "userName: " + userName + " reLoginPwd: " + reLoginPwd);
                login(userName, reLoginPwd);
            }
        }
