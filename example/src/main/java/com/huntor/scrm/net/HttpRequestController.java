...
import com.huntor.scrm.model.DealDetails;
import com.huntor.scrm.model.ModifyFansParam;
import com.huntor.scrm.net.api.ApiAddFansTargetlist;
import com.huntor.scrm.net.api.ApiConversations;
import com.huntor.scrm.net.api.ApiCreateTargetlist;
import com.huntor.scrm.net.api.ApiDeletePIntent;
import com.huntor.scrm.net.api.ApiDeleteTargetList;
import com.huntor.scrm.net.api.ApiEmployee;
import com.huntor.scrm.net.api.ApiFans;
import com.huntor.scrm.net.api.ApiFansDealCreate;
import com.huntor.scrm.net.api.ApiFansGroup;
import com.huntor.scrm.net.api.ApiFansGroupCount;
import com.huntor.scrm.net.api.ApiFansList;
import com.huntor.scrm.net.api.ApiFansModify;
import com.huntor.scrm.net.api.ApiFansPurchaseIntents;
import com.huntor.scrm.net.api.ApiFansTargetListRemove;
import com.huntor.scrm.net.api.ApiFansTargetListUpdate;
import com.huntor.scrm.net.api.ApiFansTargetLists;
import com.huntor.scrm.net.api.ApiFlushCache;
import com.huntor.scrm.net.api.ApiGetAllFansId;
import com.huntor.scrm.net.api.ApiGetTargetList;
import com.huntor.scrm.net.api.ApiKbCategorieContent;
import com.huntor.scrm.net.api.ApiKbGategories;
import com.huntor.scrm.net.api.ApiLogin;
import com.huntor.scrm.net.api.ApiModifyPwd;
import com.huntor.scrm.net.api.ApiNewTwoOld;
import com.huntor.scrm.net.api.ApiProducts;
import com.huntor.scrm.net.api.ApiQrCreate;
import com.huntor.scrm.net.api.ApiRealTimeClose;
import com.huntor.scrm.net.api.ApiRealTimeHistory;
import com.huntor.scrm.net.api.ApiRealtimeOpen;
import com.huntor.scrm.net.api.ApiRealtimeSend;
import com.huntor.scrm.net.api.ApiUpload;
