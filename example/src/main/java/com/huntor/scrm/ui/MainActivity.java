...
import com.huntor.scrm.adapter.DrawLayoutLeftAdapter;
import com.huntor.scrm.ui.Fragment.InteractionFragment;
import com.huntor.scrm.ui.Fragment.MyMemberFragment;
import com.huntor.scrm.ui.Fragment.OnlineInteractionFragment;
import com.huntor.scrm.utils.Utils;
import com.huntor.scrm.view.Button.FloatingActionButton;
...
public class MainActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void initData(){
        ...
        lvLeftMenu.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(i==0){
                    InteractionFragment itf=new InteractionFragment();
                    transaction.replace(R.id.fl_content, itf);
                    toolbar.setTitle("现场交互");
                }else if(i==1){
                    OnlineInteractionFragment otf=new OnlineInteractionFragment();
     ...
     * 水波纹按钮的点击事件
     */
    private View.OnClickListener listener_delay = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            ...
            Utils.toast(MainActivity.this,"button onclck");
        }
    };
